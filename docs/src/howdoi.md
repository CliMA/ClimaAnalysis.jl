...
## How do I take a global average over both longitude and latitude?
...
latitude-weighted average over longitude and latitude dimensions.
...
latitude dimensions and the latter computes an average of averages.

```julia
reduced_var = average_lonlat(var, "time", left = 10, right = 100)
```
