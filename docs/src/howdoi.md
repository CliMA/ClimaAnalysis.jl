...
With ClimaAnalysis 0.5.19 or later, you can do this with the `by` keyword argument for [`ClimaAnalysis.slice`](@ref) and [`ClimaAnalysis.window`](@ref). For example, you can do
