...
MakiePlace = Union{WGLMakie.Figure, WGLMakie.GridLayout}

"""
    heatmap2D!(fig::WGLMakie.Figure,
               var::ClimaAnalysis.OutputVar;
               p_loc = (1,1),
               more_kwargs)
    heatmap2D!(grid_layout::WGLMakie.GridLayout,
               var::ClimaAnalysis.OutputVar;
               p_loc = (1,1),
               more_kwargs)
...
function Visualize.heatmap2D!(
    ...
    plot = WGLMakie.heatmap!(dim1, dim2, var.data; plot_kwargs...)
...
"""
    sliced_heatmap!(fig::WGLMakie.Figure,
                    var::ClimaAnalysis.OutputVar,
                    cut::Union{Nothing, AbstractDict{String, <: Real}};
                    p_loc = (1,1),
                    more_kwargs,
                    )
    sliced_heatmap!(grid_layout::WGLMakie.GridLayout,
                    var::ClimaAnalysis.OutputVar,
                    cut::Union{Nothing, AbstractDict{String, <: Real}};
                    p_loc = (1,1),
                    more_kwargs,
...
"""
    line_plot1D!(place::WGLMakie.Figure,
                 var::ClimaAnalysis.OutputVar;
                 p_loc = (1,1),
                 more_kwargs
                 )
    line_plot1D!(place::WGLMakie.GridLayout,
                 var::ClimaAnalysis.OutputVar;
                 p_loc = (1,1),
                 more_kwargs
                 )
...
function Visualize.line_plot1D!(
    ...
    WGLMakie.Axis(place[p_loc...]; title, xlabel, ylabel, axis_kwargs...)
    WGLMakie.lines!(x, y; plot_kwargs...)
end

"""
    sliced_line_plot!(place::WGLMakie.Figure,
                      var::ClimaAnalysis.OutputVar,
                      cut::Union{Nothing, AbstractDict{String, <: Real}};
                      p_loc = (1,1),
                      more_kwargs
                      )
    sliced_line_plot!(place::WGLMakie.GridLayout,
                      var::ClimaAnalysis.OutputVar,
                      cut::Union{Nothing, AbstractDict{String, <: Real}};
                      p_loc = (1,1),
                      more_kwargs
...
"""
    line_plot!(place::WGLMakie.Figure,
               var::ClimaAnalysis.OutputVar;
               p_loc = (1,1),
               more_kwargs,
               kwargs...
               )
    line_plot!(place::WGLMakie.GridLayout,
               var::ClimaAnalysis.OutputVar;
               p_loc = (1,1),
               more_kwargs,
               kwargs...
...
"""
    sliced_plot!(place::WGLMakie.Figure,
                 var::ClimaAnalysis.OutputVar,
                 cut::Union{Nothing, AbstractDict{String, <: Real}};
                 p_loc = (1,1),
                 more_kwargs
                 )
    sliced_plot!(place::WGLMakie.GridLayout,
                 var::ClimaAnalysis.OutputVar,
                 cut::Union{Nothing, AbstractDict{String, <: Real}};
                 p_loc = (1,1),
                 more_kwargs
...
"""
    plot!(place::WGLMakie.Figure,
          var::ClimaAnalysis.OutputVar;
          p_loc = (1,1),
          more_kwargs,
          kwargs...
          )
    plot!(place::WGLMakie.GridLayout,
          var::ClimaAnalysis.OutputVar;
          p_loc = (1,1),
          more_kwargs,
          kwargs...
