...
is thrown. This function is helpful when changing the order of the categories in the plots
...
This function is helpful when changing the order of the categories in the plots produced by
