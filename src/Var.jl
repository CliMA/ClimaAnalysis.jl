...
dimensions. Otherwise, resampling is done over the dimensions in `dim_names`. If resampling
is done over all dimensions, then reordering the dimensions of the resulting `OutputVar` is
automatically done.
