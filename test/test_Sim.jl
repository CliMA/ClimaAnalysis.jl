...
@testset "SimDir" begin
    ...
    @test ClimaAnalysis.available_coords(
        simdir,
        short_name = "thetaa",
        reduction = "average",
        period = "1d",
    ) == Set(["pfullcoords"])
    @test_throws ErrorException ClimaAnalysis.available_coords(
        simdir,
        short_name = "thetaa",
        reduction = "average",
        period = "2d",
...
@testset "OutputVar" begin
    ...
    # Test coord keyword argument
    thetaa_var1 = get(simdir, short_name = "thetaa", reduction = "average")
    thetaa_var2 = get(
        simdir,
        short_name = "thetaa",
        reduction = "average",
