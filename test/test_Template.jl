...
@testset "Lazy evaluation" begin
    ...
    @test Template.call(lazy_eval, 12, a = 50) == 634
end
...
@testset "Template" begin
    ...
    var =
        ...
        Template.initialize
    # TODO: Add @test for the var above
...
@testset "Template factory" begin
    ...
    @test var.data == zeros(11, 361, 181, 11, 11)
    @test var.dims == OrderedDict(
