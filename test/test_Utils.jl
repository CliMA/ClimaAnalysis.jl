...
@testset "Regexp" begin
    ...
    @test Utils.match_nc_filename("ta_1d_average_pfull.nc") ==
          Tuple(["ta", "1d", "average", "pfull"])

    @test Utils.match_nc_filename("ta_1.0d_average_pfull.nc") ==
          Tuple(["ta", "1.0d", "average", "pfull"])
end
