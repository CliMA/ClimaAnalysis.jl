...
@testset "Shift longitudes" begin
    ...
    @test var_neg_180_180.dims["lon"] == collect(range(-180, 179, 360))
    @test var_neg_180_180.data == vcat(
        collect(range(180.0, 359.0, 180)),
        collect(range(0.0, 179.0, 180)),
    )
    ...
    # Center longitudes with 2D OutputVar and 3D OutputVar
